#!/usr/bin/env bash
# Runner: Architect — analyzes codebase and produces implementation plans
set -euo pipefail
...
$ARCH_PLAN"
  ...
  board_add_comment "$ISSUE_KEY" "Card architected by Sorta.Fit on $(date '+%Y-%m-%d %H:%M'). Implementation plan appended to description."
